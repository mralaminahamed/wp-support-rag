...
from apps.api.db.models import Document, IngestionRun, Plugin, Source
from apps.api.db.redis import get_redis
from apps.api.ingestion.adapters.base import RawDocument, SourceAdapter, SourceContext
from apps.api.ingestion.adapters.github import GitHubAdapter
from apps.api.ingestion.adapters.wporg import WporgAdapter
from apps.api.ingestion.normalize import normalize
from apps.api.ingestion.summary import IngestSummary
from apps.api.processing.centroid import refresh_plugin_centroid
from apps.api.processing.chunker import chunk_document
from apps.api.processing.embedder import (
    EmbeddingClient,
